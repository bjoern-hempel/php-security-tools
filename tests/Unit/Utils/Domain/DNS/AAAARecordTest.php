...
final class AAAARecordTest extends TestCase
{
    ...
    public function wrapper(int $number, string $domain, bool $all, string|array $expected): void
    {
        ...
        /* Act */
        $current = $all ? $aaaaRecord->getAll($domain) : $aaaaRecord->getString($domain);
    ...
    public function dataProvider(): array
    {
        ...
        return [
            [++$number, BaseRecord::NAME_FAKE_HOSTNAME, false, BaseRecord::NAME_FAKE_IPV6, ],
            [++$number, BaseRecord::NAME_FAKE_HOSTNAME, true, BaseRecord::VALUES_FAKE_HOSTNAME_AAAA, ]
        ];
    }
}
